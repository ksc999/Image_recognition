...
E --> G[image recover before decrypt]
F --> G
G --> |semi-recoverd image| H[get hidden information from the semi-recoverd image]
H --> |encoded information| I[decrypt the hidden information] --> Q((infomation))
G --> |semi-recoverd image| J[fully-recover the image] --> P((image))
```
...
![image-20210702185542441](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\image-20210702185542441.png)

由此可见，虽然好于空域，但仍不具有可读性。